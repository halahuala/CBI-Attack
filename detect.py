...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        total_time = dt[0].dt + dt[1].dt + dt[2].dt
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / './Demo-weights/YOLOv5s-backdoor.pt', help='model path or triton URL')
    parser.add_argument('--source', type=str, default=ROOT / './dataset/backdoor_test', help='file/dir/URL/glob/screen/0(webcam)')
